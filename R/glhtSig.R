...
#'@param object An object saved from \code{glht()} from the \pkg{multcomp}
#'package.
#'@param test A function for computing p-values.  See help for \code{glht}.
#'@param alpha A numeric indicated the rejection criterion to be used for
#'identifying significant comparisons.  Defaults to \code{0.05}.
#'@param \dots Other arguments to pass through to \code{summary.glht()}.
#'@return A vector containing the names of the paired comparisons that have a
