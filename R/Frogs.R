...
#'
#'Hypothetical population of numbers of frogs on lakes as determined by call
#'and visual methods.
#'
#'@name Frogs
#'@docType data
#'@format A data frame with 1000 observations on the following 2 variables:
#'\describe{ \item{call}{Abundance determined from the \sQuote{call} method.}
...
#'@source Randomly determined from realistic values provided by the Sigurd
#'Olson Environmental Institute, Northland College, Ashland, WI.
#'@keywords datasets
NULL
