...
#' 
#'Modifies the print.lm() function so that the output is less verbose.  For
#'example, the call will not be re-printed unless asked for.  In addition, 
#'several \sQuote{extra} blank lines were removed.
#' 
#'@aliases print.lm
